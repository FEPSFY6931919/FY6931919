...
function displayTotalWordCount() {
    ...
    const IntroductionCount = displayWordCount("intro_text");
    const AnalysisCount = displayWordCount("analysis_text");
    const totalWordCount = IntroductionCount + AnalysisCount;   // Calculate the sum of all selected sections
